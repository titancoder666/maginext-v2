...
export const ARTICLES = [
  ...
  { slug: 'gpa-low-transfer', cat: '转学', catColor: '#2563eb',
    ...
    excerpt: '李同学 GPA 2.3 时找到我们。两年后他被 UC Berkeley CS 录取。这是完整时间线。',
    author: 'Dr. Sarah Chen · 前 UC Berkeley 招生官', date: '2026.04.10', readTime: '18 分钟', views: '41,209',
    featured: true,
    keywords: ['GPA 太低 转学', 'CC 转 UC', '美本低 GPA 救援'] },
